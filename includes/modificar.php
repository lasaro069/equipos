...
<div class="contenedor-formulario">
    ...
    <form class="formulario-ingreso" action="procesar_ingreso.php" method="post" enctype="multipart/form-data">
        ...
        <div class="contenedor-inputs">
            ...
            <input class="entrada-datos" type="text" id="nr_inventario" name="nr_inventario" required placeholder="Este campo no debe poder modificarse. "><br>
        ...
        <input class="boton-ingresar" type="submit" value="Actualizar">
    </form>
